{{-- #BACKEND Navigasi Bawah Smartphone / Smartphone Bottom Navigation Bar
     id: Navigasi khusus layar ponsel/mobile. Mengontrol pergantian tab viewport ponsel (Asisten AI, Status & Info, Tiket PNR, dan Modal Perjalanan).
     en: Mobile-specific bottom navigation bar. Controls mobile viewport tab switching (AI Assistant, Status & Info, PNR Tickets, and Trips Modal). --}}
<!-- Smartphone Bottom Navigation Bar (Muncul Hanya di Layar HP / Mobile) -->
<nav class="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-2 pt-1.5 pb-3 sm:pb-1.5 flex items-center justify-around shadow-floating select-none">
    
    {{-- id: Tab 1: Asisten AI (Chat)
         en: Tab 1: AI Assistant (Chat) --}}
    ...
    <button @click="mobileTab = 'assistant'"
            ...
            class="flex flex-col items-center justify-center py-1 px-3 rounded-xl transition relative cursor-pointer">
        <div class="relative">
    ...
    {{-- id: Tab 2: Status Penerbangan & Detail Kebijakan
         en: Tab 2: Flight Status & Policy Details --}}
    ...
    <button @click="mobileTab = 'details'"
            ...
            class="flex flex-col items-center justify-center py-1 px-3 rounded-xl transition cursor-pointer">
    ...
    {{-- id: Tab 3: Daftar Tiket PNR
         en: Tab 3: PNR Tickets List --}}
    ...
    {{-- id: Tab 4: Modal Daftar Perjalanan Saya
         en: Tab 4: My Trips List Modal Trigger --}}
    <!-- Tab 4: My Trips -->
    <button @click="showMyTripsModal = true"
            class="flex flex-col items-center justify-center py-1 px-3 rounded-xl text-slate-500 font-medium hover:text-slate-900 transition cursor-pointer">
